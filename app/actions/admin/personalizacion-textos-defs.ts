...
export const GRUPOS_TEXTOS: GrupoTextos[] = [
  ...
  },
  {
    ...
    campos: [
      {
        key: 'tarjetasEyebrow',
        name: 'txt_tarjetas_eyebrow',
        label: 'Antetítulo de la sección',
        rows: 1,
      },
      {
        key: 'tarjetasTitulo',
        name: 'txt_tarjetas_titulo',
  ...
  },
  {
    ...
    campos: [
      {
        key: 'reunionesEyebrow',
        name: 'txt_reuniones_eyebrow',
        label: 'Antetítulo de la sección',
        rows: 1,
      },
      {
        key: 'reunionesTitulo',
        name: 'txt_reuniones_titulo',
        label: 'Título de la sección',
        rows: 2,
      },
      {
        key: 'reunionesPanelVacio',
        name: 'txt_reuniones_panel_vacio',
        label: 'Panel derecho · aviso «selecciona un día»',
        rows: 2,
      },
    ],
  },
